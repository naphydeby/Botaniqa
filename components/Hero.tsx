...
const Hero = () => {
  ...
  return (
    <section className='bg-cover bg-center bg-no-repeat min-h-screen py-12 px4  md:py-20 ' style={{ backgroundImage: 'url(/image/basil.jpg)' }} id='home'>
    <div className='container mx-auto px-2  text-center'>
        <div className='flex flex-col space-y-8 md:space-y-12   '>
                <h1 className='text-4xl sm:text-5xl md:text-7xl  font-bold leading-tight '>Natural Healing Through
